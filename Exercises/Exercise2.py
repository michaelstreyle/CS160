...
class Animal(ABC): #inherites from ABC
    '''Class Animal'''
    @abstractmethod
...
class Mammal(Animal):
    ...
    def __init__(self, spec_init, age_init, color_init, habitat_init):
        ...
        if habitat_init == "Land":
            self._habitat = habitat_init
        elif habitat_init == "Sea":
            self._habitat = habitat_init
        elif habitat_init == "Air":
            self._habitat = habitat_init
        elif habitat_init == "Tree":
            self._habitat_init = habitat_init
        else:
