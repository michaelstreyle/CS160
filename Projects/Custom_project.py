...
class Adults():
    ...
    def work(self):
        return str(self._name) + ' is working'

    def reading(self):
        return str(self._name) + ' is reading'
...
class Pets():
    ...
    def potty(self):
        '''Pet goes to the bathroom'''
        return "Pet has gone to the bathroom!"
...
class Sheep(Pets):
    ...
    @property 
    def sheep_inside(self):
        ''' sheep inside property getter'''
        return self._inside
    @sheep_inside.setter
    def sheep_inside(self, value):
        '''sheep inside property setter'''
        self._inside = value
